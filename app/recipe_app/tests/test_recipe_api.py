...
def sample_recipe(user, **params):
    ...
    defaults.update(params)  # customize the defautls
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        serializer = RecipeSerializer(recipes, many=True)  # list view
    ...
    def test_create_recipe_with_ingrediens(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test that uploading image to recipe is successful."""
        url = image_upload_url(self.recipe.id)
        with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
            img = Image.new('RGB', (10, 10))
            img.save(ntf, format='JPEG')  # seek is now at the eof
            ntf.seek(0)
    ...
    def test_filter_recipes_by_tags(self):
        ...
        # self.assertNotIn(serializer3.data, res.data) TODO: FIX
